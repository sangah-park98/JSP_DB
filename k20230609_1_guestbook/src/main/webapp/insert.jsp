...
<form action="insertOK.jsp">
	<table width="600" border="1" cellpadding="5" cellspacing="0" align="center">
		<tr>
			<th colspan="2" style="background-color: mistyRose">♥ 방명록 쓰기 ♥</th>
		</tr>
		<tr>
			<th width="100">
		...
		<tr>
			<td colspan="2" align="center">
				<input class="button button1" type="submit" value="글 남기기"/>
