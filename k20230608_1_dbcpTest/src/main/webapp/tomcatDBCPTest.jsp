...
//	META-INT 폴더에 context.xml 파일을 만든다. => context.xml 파일을 복사해 넣는다. => 데이터베이스 연결정보
//	web.xml 파일에 아래의 내용을 코딩한다.
//<!-- tomcatDBCP 사용 설정 -->
//	<resource-ref>
//		<description>설명, 안 써도 됨</description>
...
//	</resource-ref>
	...
	try {
		...
		// 위의 주석으로 처리한 2줄은 tomcat server 7.0부터 아래와 같이 1줄로 줄여서 사용한다.
