...
//	memoList4.jsp에서 넘어오는 수정할 글번호(idx)와 수정후 돌아갈 페이지 번호(currentPage)를 받는다.
...
//	수정할 글번호와 수정후 돌아갈 페이지 번호가 모두 넘어왔나 검사한다.
	...
	<table width="700" border="1" align="center" cellpadding="5" cellspacing="0">
		...
		<tr>
			...
			<td>
				...
				<input type="text" name="name" value="<%=rs.getString("name")%>" readonly="readonly" style="border: none;">	
			</td>
		...
		<tr>
			<td colspan="2" align="center">
				...
				<input type="button" value="돌아가기1" onclick="location.href='memoList4.jsp?currentPage=<%=currentPage%>'"/>
				<!-- <input type="button" value="돌아가기2" onclick="history.back()"/> -->
				<!-- <input type="button" value="돌아가기3" onclick="history.go(-1)"/> -->
			</td>
		</tr>
	</table>
	
	<!-- 수정할 글번호와 수정후 돌아갈 페이지 번호도 deleteOK.jsp로 넘겨줘야 한다. -->
...
<%				
				...
				out.println("<script>");
				out.println("alert('" + idx + "번 글은 게시판에 존재하지 않습니다.')");
