...
//	memoList4.jsp에서 넘어오는 삭제할 글번호(idx)와 삭제후 돌아갈 페이지 번호(currentPage)를 받는다.
...
//	삭제할 글번호와 삭제후 돌아갈 페이지 번호가 모두 넘어왔나 검사한다.
...
<form action="deleteOK.jsp" method="post">
	...
	<!-- 삭제할 글번호와 삭제후 돌아갈 페이지 번호도 deleteOK.jsp로 넘겨줘야 한다. -->
