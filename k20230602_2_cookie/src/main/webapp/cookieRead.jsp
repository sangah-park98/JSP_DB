...
//	out.println(Arrays.toString(cookies) + "<br/>");
	...
	for(Cookie cookie: cookies) {
		...
		// tomcat server 8.0 이하 버전에서는 내용이 한글인 쿠키를 저장할 때 에러가 발생되기 때문에 인코딩
		// 과정을 거쳐서 쿠키를 저장해야 했지만 읽어올 때는 에러가 발생되지 않는다.
		// 다만, FB6308~~~~와 같이 인코딩된 유니코드 자체를 가져오기 때문에 읽을 수 없다.
		// tomcat server 8.0 이하 버전에서 인코딩돼서 저장된 쿠키의 내용을 읽으려면 디코딩 과정을 거쳐야 
		// 읽을 수 있다.
